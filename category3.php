...
if(isset($_SESSION["USERNAME"]) && !empty($_SESSION["USERNAME"]))
{
 ...
 if(isset($userid) && !empty($userid))
  {  
	...
	$result1=mysqli_query($conn,"SELECT * FROM form WHERE userid='$userid' AND category3 = '0'");
...
if (isset($_POST['vote'])) {
    ...
    $sql = "UPDATE form SET category3=category3+1  WHERE userid= '$set'";
...
$sql = "UPDATE category3 SET vote=vote+1  WHERE id= $vote";
